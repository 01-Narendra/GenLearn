...
GenLearn is a platform that allows users to easily create
...
- **AI-Generated Courses**: The platform uses AI to generate a complete course structure based on user input and then generate the content.
- **YouTube Video Integration**: The AI automatically attaches relevant YouTube videos to each chapter of the course by using youtube API.
